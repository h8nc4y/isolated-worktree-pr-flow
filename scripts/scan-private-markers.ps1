...
$ownRepoUrlPattern = '^https://github\.com/h8nc4y/isolated-worktree-pr-flow(?:\.git)?$'
...
$environmentMarkers = [Environment]::GetEnvironmentVariable('ISOLATED_WORKTREE_PR_FLOW_PRIVATE_MARKERS')
